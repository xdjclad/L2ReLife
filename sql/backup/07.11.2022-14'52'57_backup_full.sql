...
CREATE TABLE `accounts` (
  ...
  `lastactive` int unsigned DEFAULT '0',
  ...
  `bonus_expire` int DEFAULT '0',
  `banExpires` int DEFAULT '0',
  `AllowIPs` varchar(256) DEFAULT '*',
  `points` int DEFAULT '0',
  `lock_expire` int DEFAULT '604800',
  `activated` tinyint unsigned DEFAULT '1',
...
CREATE TABLE `banned_ips` (
  `ip` varchar(15),
  `admin` varchar(45),
  `expiretime` int unsigned DEFAULT '0',
...
CREATE TABLE `referrals` (
  `login` varchar(45) DEFAULT '',
  `server` tinyint unsigned DEFAULT '0',
  `char` int unsigned DEFAULT '0',

...
public class ThreadPoolManager
{
	...
	private static ThreadPoolExecutor _executor2 = new ThreadPoolExecutor(Math.max(1, ConfigValue.ExecutorThreadPoolSize), Integer.MAX_VALUE, 5L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new PriorityThreadFactory("ThreadPoolExecutor", Thread.NORM_PRIORITY), new CallerRunsPolicy());
